...
export const SidebarData = [
    ...
    {
        //title: "Map",
        icon: <img src={MapIcon} alt="Map" style={{ width: '24px', height: '24px' }} />,
        link: "/map"
    },
    {
        //title: "Like",
        icon: <img src={LikeIcon} alt="Like" style={{ width: '24px', height: '24px' }} />,
        link: "/like"
    },
    {
        //title: "Save",
        icon: <img src={SaveIcon} alt="Save" style={{ width: '24px', height: '24px' }} />,
        link: "/save"
    },
    {
        //title: "Exit",
        icon: <img src={ExitIcon} alt="Exit" style={{ width: '24px', height: '24px' }} />,
        link: "/exit",
        className: "exit"  
    }
];
